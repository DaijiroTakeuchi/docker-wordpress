...
function shortcode_map($atts, $content) {
    ...
    return sprintf('<iframe src="%s" width="%s" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>', $att['url'], $att['width']); // HTMLに出力されるつまりページに表示される
}
add_shortcode('my_map', 'shortcode_map');
